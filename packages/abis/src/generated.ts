...
export const universeManagerAbi = [
  ...
  { type: 'event', anonymous: false, inputs: [], name: 'TokenGraduation' },
  {
    type: 'event',
    anonymous: false,
    inputs: [
...
/**
 * Wraps __{@link useWatchContractEvent}__ with `abi` set to __{@link universeManagerAbi}__ and `eventName` set to `"TokenGraduation"`
 */
export const useUniverseManager_TokenGraduation_watch =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: universeManagerAbi,
    eventName: 'TokenGraduation',
  })
