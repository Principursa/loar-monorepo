...
import {IPoolManagerEvents} from "./interfaces/IPoolManagerEvents.sol";
...
contract HookTest is Test, Deployers, IPoolManagerEvents, IHookEvents {
    ...
    function initPoolAndAddLiquidity(
        ...
        modifyLiquidityRouter.modifyLiquidity{value: msg.value}(
            _key,
            LIQUIDITY_PARAMS,
            ZERO_BYTES
        );
    ...
    function calculateFeeDelta(
        ...
        (int128 fees0, int128 fees1) = calculateFees(
            manager,
            poolId,
            owner,
            tickLower,
    ...
    function modifyPoolLiquidity(
        ...
        ModifyLiquidityParams
            memory modifyLiquidityParams = ModifyLiquidityParams({
                tickLower: tickLower,
                tickUpper: tickUpper,
